// SSDK Component Library - Reusable Glassmorphic UI Components
...
export class GlassComponents {
   ...
   */
  static createTextarea(id, placeholder = "Enter input...", label = "", rows = 6) {
   ...
   */
  static createInput(id, type = "text", placeholder = "", label = "", defaultValue = "") {
    const wrap = document.createElement("div");
    wrap.className = "field-grid-1";
